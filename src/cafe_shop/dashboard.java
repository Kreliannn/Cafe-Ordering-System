...
public class dashboard extends javax.swing.JFrame {
    ...
    public dashboard(employee params) {
        ...
        products.setText(Integer.toString(productClass.getCount()));
        supplier.setText(Integer.toString(productClass.getSupplier()));
        ingredients.setText(Integer.toString(ingredientClass.getCount()));
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel2.setText("SALES");

        sales.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N
        sales.setText("0");
        ...
        ingredients.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N
        ingredients.setText("0");
        ...
        customer.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N
        customer.setText("0");
        ...
        employee.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N
        employee.setText("0");
        ...
        supplier.setFont(new java.awt.Font("Arial", 1, 48)); // NOI18N
        supplier.setText("0");

...
public class employeeLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        employeeBackend customerClass = new employeeBackend();
        
        employee loginEmployee = customerClass.getAccount(usernameVal, passwordVal);
        
        if(loginEmployee.getEmployeeId() != 0)
        {
            customHooks.changeFrame(this, new cashierPage(loginEmployee));
        }
        else
        {
